...
export default function ContactPage() {
  const whatsappLink = socialLinks.find(s => s.platform === 'WhatsApp')?.url || 'https://wa.me/254768682374';
              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-3 w-full px-6 py-4 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-green-600/25"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
